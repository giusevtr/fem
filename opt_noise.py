...
def optimize(data, query_manager, epsilon, epsilon_0, samples, max_iter, timeout=300, show_prgress=False, show_plot=True):
    ######################################################
    ...
    domain = [{'name': 'noise', 'type': 'continuous', 'domain': (0.75, 3)}]
