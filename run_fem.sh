...
#    python generate.py loans 24 5 0.1 0.15 0.20 0.25 0.5 1  newadafem --samples=100 --noise="$n" --eps0="$eps0"
     python fem.py adult 64 3 0.1 --samples=50 --noise_multiple="$n" --epsilon_split="$eps0"
     python fem.py adult 64 5 0.1 --samples=50 --noise_multiple="$n" --epsilon_split="$eps0"
     python fem.py loans 64 3 0.1 --samples=50 --noise_multiple="$n" --epsilon_split="$eps0"
     python fem.py loans 64 5 0.1 --samples=50 --noise_multiple="$n" --epsilon_split="$eps0"
